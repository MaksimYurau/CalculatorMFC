...
// CalculatorMFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalculatorMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCalculatorMFCApp

CCalculatorMFCApp::CCalculatorMFCApp()
{
...
// Единственный объект CCalculatorMFCApp

CCalculatorMFCApp theApp;


// Инициализация CCalculatorMFCApp

BOOL CCalculatorMFCApp::InitInstance()
{
